...
def _run_full_pipeline() -> None:
    """Phase 1 → Phase 2 순차 실행. 완료 후 rerun."""
    from dashboard.components.analysis_runner import run_phase_analysis

    progress = st.progress(0, text="감사 파이프라인 시작...")
    try:
        progress.progress(10, text="Phase 1 룰 기반 탐지 실행 중...")
        run_phase_analysis(phase="phase1")
        progress.progress(60, text="Phase 2 이상 탐지 실행 중...")

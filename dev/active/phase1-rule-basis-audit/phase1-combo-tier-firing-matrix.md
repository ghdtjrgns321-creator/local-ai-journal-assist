...
period_end_adjustment_high       0.75  HIGH   closing_timing      (L3-04|L3-11) & (L3-10|L4-04|L4-03)                      HIGH-4
...
2. **period_end_adjustment_high** (515~521줄): `has_timing_seed`(`rule_ids & {L3-04,L3-11}`, 32·484줄) AND `has_period_end_corroborant`(`rule_ids & {L3-10,L4-04,L4-03}`, 36·487줄). → `(L3-04|L3-11)&(L3-10|L4-04|L4-03)`. doc §3.0 HIGH-4 일치(L4-03 복원 §8(1), L3-07·L1-08 삭제 §8(5) — 코드 31·35줄 주석 확인).

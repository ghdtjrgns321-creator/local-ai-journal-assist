...
The matching documentation in `docs/PHASE1_TOPIC_SCORING_V1_LOCK.md` and `docs/PHASE1_RULE_RELATIONSHIP_MAP.md` explicitly frames these as datasynth calibration allowances. That wording should be revised to an anti-fitting policy.
...
**Tasks**:
- [ ] Update `docs/PHASE1_TOPIC_SCORING_V1_LOCK.md`.
...
- [ ] Run detection module tests: `.venv\Scripts\pytest.exe tests\modules\test_detection -q`.
  ...
  - Size: M
- [ ] Rerun manipulation profile using the same command documented in `docs/DETECTION_RESULTS_MANIPULATION.md`.
...
- Docs: `docs/PHASE1_TOPIC_SCORING_V1_LOCK.md`, `docs/PHASE1_RULE_RELATIONSHIP_MAP.md`, `docs/DETECTION_RESULTS_MANIPULATION.md`.

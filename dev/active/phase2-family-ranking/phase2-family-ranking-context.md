...
- `docs/PHASE2_GOVERNANCE_DESIGN.md` — 결정 8 추가 (Phase F)
- `docs/PHASE2_INTERFACE_DESIGN.md` — §4.4 보강 (Phase F)
- `docs/DETECTION_RESULTS_MANIPULATION_V7_FIXED3_PHASE2.md` — §6 보강 (Phase F)
- `docs/DECISION.md` — D044 PR 템플릿 tier 변경 fitting-risk check (Phase A)
...
- `docs/PHASE2_GOVERNANCE_DESIGN.md` 결정 4~7 — 기존 lock 정합 확인
- `docs/PHASE2_INTERFACE_DESIGN.md` 결정 3 옵션 Z — independent queue 원칙
- `docs/DETECTION_RULES.md` §3.3 A3 Family Matrix — family·sub-detector 목록 진본
...
- `docs/PHASE2_GOVERNANCE_DESIGN.md` 결정 4~7, kpi_baseline.json 패턴
- `docs/PHASE2_INTERFACE_DESIGN.md` 결정 3 옵션 Z
- `docs/DETECTION_RESULTS_MANIPULATION_V7_FIXED3_PHASE2.md` §3·§4·§6
- `artifacts/phase2_family_correlation_matrix_20260519.md` Spearman·Jaccard
- `docs/CONSTRAINTS.md` PHASE1 truth-recall-guard 3-Layer 정책

...
## Progress Summary
0 / 31 tasks complete (0%)

## Phase 1: Training Domain Foundation
- [ ] `Phase2TrainingStatus` enum 정의
...
- [ ] ablation variant 변환 helper 추가
  ...
  - Size: M
- [ ] variant별 FeatureGroups 재구성 helper 추가
  - File: `src/services/phase2_training_service.py`
...
- [ ] 신규 training report 직렬화 포맷 문서화
- [ ] phase2-infer 회귀 테스트 통과
- [ ] dashboard가 training report 없을 때 graceful fallback 유지

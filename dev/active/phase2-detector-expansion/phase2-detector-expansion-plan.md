...
- `docs/DETECTION_RULES.md`는 최신화되었지만, DataSynth 16개 유형과 실제 detector family 매핑은 아직 부분적이다.
...
- [ ] `docs/DETECTION_RULES.md`와 `docs/PHASE_PROVENANCE.md` 후속 반영 - File: `docs/DETECTION_RULES.md` - Size: S

...
- 공식 원칙 문서: [DETECTION_RULES.md](DETECTION_RULES.md)
- 하이퍼파라미터 문서: [DETECTION_PARAMETERS.md](DETECTION_PARAMETERS.md)
- troubleshooting 기록: [TROUBLESHOOT.md](TROUBLESHOOT.md)
- 전용 설정 파일: [config/phase1_case.yaml](/abs/path/C:/Users/ghdtj/workspace/portfolio/local-ai-assist/config/phase1_case.yaml)

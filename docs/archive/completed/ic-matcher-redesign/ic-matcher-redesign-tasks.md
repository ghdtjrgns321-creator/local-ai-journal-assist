...
### T-P3-1: `docs/spec/DETECTION_RULES.md` 갱신
- File: `docs/spec/DETECTION_RULES.md:1085~1132`
- 변경:
...
### T-P3-2: `docs/spec/DETECTION_REFERENCE.md` 신규 절
- File: `docs/spec/DETECTION_REFERENCE.md:153~241`
- 변경:
...
### T-P3-3: `docs/spec/RULE_DETAIL_METADATA_V1_LOCK.md` 갱신
- File: `docs/spec/RULE_DETAIL_METADATA_V1_LOCK.md`
- 변경:
...
### T-P3-4: `docs/spec/PHASE1_TOPIC_SCORING_V1_LOCK.md` 갱신
- File: `docs/spec/PHASE1_TOPIC_SCORING_V1_LOCK.md`
- 변경:
...
### T-P3-5: `docs/spec/PHASE1_RULE_RELATIONSHIP_MAP.md` 갱신
- File: `docs/spec/PHASE1_RULE_RELATIONSHIP_MAP.md:80`
...
### T-P3-6 (**신규, 보정 #4 반영**): `docs/spec/DECISION.md` D055 supersede 결정문 추가
- File: `docs/spec/DECISION.md`
- 변경:
  ...
  - 신규 D0xx 결정문 본문 추가 — 다음 절 포함:
    ...
    - **영향 범위**: `src/detection/intercompany_rules.py`, `src/detection/intercompany_matcher.py`, `src/detection/score_aggregator.py`, `config/audit_rules.yaml`, `config/settings.py`, `tools/scripts/build_datasynth_v38_ic_exception_labels.py`, `docs/spec/DETECTION_RULES.md`, `docs/spec/DETECTION_REFERENCE.md`, `docs/spec/RULE_DETAIL_METADATA_V1_LOCK.md`, `docs/spec/PHASE1_TOPIC_SCORING_V1_LOCK.md`, `docs/spec/PHASE1_RULE_RELATIONSHIP_MAP.md`.
...
- [x] `docs/spec/DETECTION_RULES.md`, `DETECTION_REFERENCE.md`, `RULE_DETAIL_METADATA_V1_LOCK.md`, `PHASE1_TOPIC_SCORING_V1_LOCK.md`, `PHASE1_RULE_RELATIONSHIP_MAP.md` 갱신 완료 — T-P3-1~5
- [x] `docs/spec/DECISION.md` D055 supersede 라인 + D065 신규 결정문 추가 완료 — T-P3-6
...
- [ ] `dev/active/ic-matcher-redesign/` 완료 후 `docs/archive/completed/` 이관 — 후속 작업

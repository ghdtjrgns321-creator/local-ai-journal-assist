...
- `docs/spec/PHASE2_GOVERNANCE_DESIGN.md`: 결정 4~7 lock 완료, family ranking 결합 정책은 미정의
- `docs/spec/PHASE2_INTERFACE_DESIGN.md`: 결정 3 옵션 Z (independent queue) lock, PHASE2 internal ranking은 별도 결정 필요
- `docs/guide/DETECTION_RESULTS_MANIPULATION_V7_FIXED3_PHASE2.md` §6: scenario × family 보완성 표는 있으나 결합식 부재
...
- [ ] D044 PR 템플릿에 tier 변경 fitting-risk check 추가 - File: `docs/spec/DECISION.md` - Size: S
...
**Tasks**:
- [ ] 결정 8 추가 — RRF 적용 범위 제한 + Phase C 측정 인용 + tie-break 가드 + lane 정책 - File: `docs/spec/PHASE2_GOVERNANCE_DESIGN.md` - Size: M
- [ ] PHASE2_INTERFACE_DESIGN.md §4.3/§4.4 보강 — lane 추가, family_contributions citation - File: `docs/spec/PHASE2_INTERFACE_DESIGN.md` - Size: S
- [ ] V7_FIXED3_PHASE2 §6 끝에 family ranking 정책 + Phase C measurement 인용 - File: `docs/guide/DETECTION_RESULTS_MANIPULATION_V7_FIXED3_PHASE2.md` - Size: S
...
- Docs:
  ...
  - `docs/guide/DETECTION_RESULTS_MANIPULATION_V7_FIXED3_PHASE2.md`

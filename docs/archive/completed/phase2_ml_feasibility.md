...
> - `docs/spec/DECISION.md::D038` — FT-T 유지 + 분기별 ablation 정책 문서화
>
...
> - 문서(`docs/archive/completed/raw-plan/05a-detection-ml.md`, `TASKS.md`)에는 "5-fold OOF prediction" 명시
> - **문서-코드 괴리 확정**
>
...
> - `docs/spec/DECISION.md::D037` — SOC 2 / ISO 27001 대응 재학습 정책
...
> | **P3** | 정책 문서화 | S | docs/spec/DECISION.md에 추가 |
>

...
> 상세 컬럼 사전: `data/journal/primary/datasynth/PREVIEW.md` (현재 체크아웃에 없음)
> 생성 원칙: `data/journal/primary/datasynth/generation_principles.md` (현재 체크아웃에 없음)
...
- `docs/spec/DETECTION_RULES.md`: DataSynth **52개** anomaly 유형 기준

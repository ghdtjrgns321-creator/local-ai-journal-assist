...
[테스트 결과](../../../../tests/modules/test_feature/test-results/feature-test-summary.md#5-엔진-오케스트레이터-14-cases)
...
**테스트**: [test_time_features.py](../../../../tests/modules/test_feature/test_time_features.py) — 49 케이스 | [테스트 결과](../../../../tests/modules/test_feature/test-results/feature-test-summary.md#time_features-49-cases)
...
**테스트**: [test_amount_features.py](../../../../tests/modules/test_feature/test_amount_features.py) — 27 케이스 | [테스트 결과](../../../../tests/modules/test_feature/test-results/feature-test-summary.md#amount_features-27-cases)
...
**테스트**: [test_pattern_features.py](../../../../tests/modules/test_feature/test_pattern_features.py) — 42 케이스 | [테스트 결과](../../../../tests/modules/test_feature/test-results/feature-test-summary.md#pattern_features-42-cases)
...
**테스트**: [test_text_features.py](../../../../tests/modules/test_feature/test_text_features.py) — 38 케이스 | [테스트 결과](../../../../tests/modules/test_feature/test-results/feature-test-summary.md#text_features-38-cases)
...
**UX 원칙** ([ux-flow.md → 3가지 원칙](../../../guide/ux-flow.md#3가지-ux-디자인-원칙)):
...
> 이 섹션은 [ux-flow.md → UX 2단계](../../../guide/ux-flow.md#ux-2단계-감사-룰-세팅--파생변수-생성-feature--엔진-구현-완료-ui-예정)의 상세 구현입니다.
...
| [DETECTION_RULES.md](../../../spec/DETECTION_RULES.md)                        | 22→36→41개 유형 Tier 분류, 점수 체계       |
| [08-llm.md](08-llm.md)                                            | Ollama, Vanna Text-to-SQL, Insight 생성    |
| [ux-flow.md](../../../guide/ux-flow.md)                                          | UX 2단계, 스마트 디폴트, 프로파일 재사용   |
...
> 출처: [feature-test-summary.md](../../../../tests/modules/test_feature/test-results/feature-test-summary.md), [e2e-datasynth.md](../../../../tests/test_feature/test-results/e2e-datasynth.md), [e2e-sap-merged.md](../../../../tests/test_feature/test-results/e2e-sap-merged.md)

| Phase | 모듈           | 문제                                  | 현상                                            | 해결 위치                                                                      |
|:------|:---------------|:--------------------------------------|:------------------------------------------------|:-------------------------------------------------------------------------------|
| ~~2~~ | ~~engine~~     | ~~FeatureResult 상세 로그~~           | ~~경고/스킵 사유 미기록~~                       | ✅ **해결됨** — `warnings` 필드 추가 완료                                      |
| ~~1b~~ | ~~engine~~         | ~~rules 전달 형식 불일치~~            | ~~`get_audit_rules()` 중첩 dict 전달 시 pattern 피처 전부 False~~ | ✅ **해결됨** — `engine.py:117-119` 자동 언래핑 추가. [발견](../../../../tests/modules/test_detection/test-results/e2e-detection-datasynth.md) |

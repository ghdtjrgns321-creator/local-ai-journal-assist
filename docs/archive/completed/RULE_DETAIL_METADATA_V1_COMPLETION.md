...
This document records the completed Rule Detail Metadata v1 implementation. It is a completion note only; it does not change the locked v1 contract in `docs/spec/RULE_DETAIL_METADATA_V1_LOCK.md`.

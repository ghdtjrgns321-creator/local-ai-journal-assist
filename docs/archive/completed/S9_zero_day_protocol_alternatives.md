...
- v3 contract dataset 에는 `expense_capitalization_plausible_cases (33)` + `expense_capitalization_normal_capex_controls (90)` 의 sidecar 가 이미 존재한다 (`docs/archive/completed/datasynth_contract_sidecar_taxonomy_v126.csv:62`).

...
See [LOCAL_FIRST_EVIDENCE_POLICY.md](../../spec/LOCAL_FIRST_EVIDENCE_POLICY.md) and [DECISION.md §D068](../../spec/DECISION.md).
...
- 2026-05-15: Historical Sprint A-G implementation records were written under `docs/archive/completed/`.

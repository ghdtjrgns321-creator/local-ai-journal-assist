...
원본 데이터 기준: DataSynth v1.2.0 (106,489건 전표, 1,104,914 라인아이템, 39컬럼).
...
| 이상징후 요약       | `anomaly_flag_summary`   | 이상 전표 7.5%, 부정 의심 1.9%, SoD 위반 11.7% |
...
- KPI 카드: 전표 건수, 이상 비율(7.5%), 부정 의심(1.9%), SoD 위반(11.7%)
...
DataSynth 기준 1,104,914 라인아이템은 Excel 행 제한(1,048,576)을 초과할 수 있다.

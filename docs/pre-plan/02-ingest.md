...
**테스트:** [39개 통과](../../tests/test_ingest/test-results/ingest-type-caster.md) (cast_amount 9 + cast_date 8 + cast_int 4 + cast_str 5 + cast_bool 3 + unify 4 + 퍼사드 6)
...
- **header_detector:** 1행 헤더, 3행 헤더, 병합셀 헤더, 메시지 3단계 ✅ 12 passed
- **column_mapper:** 완전 매칭, 부분 매칭, 전혀 다른 컬럼명, fast path, 충돌 해결 ✅ 25 passed
- **type_caster:** 쉼표 금액, 괄호 음수, 다양한 날짜 포맷, str 캐스팅 ✅ 39 passed

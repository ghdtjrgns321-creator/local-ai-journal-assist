...
**테스트**: 62 tests passed (4.61s) — 8개 테스트 파일

| 테스트 파일                 | 케이스 수 | 결과 리포트                                                                             |
|:----------------------------|:---------:|:----------------------------------------------------------------------------------------|
| test_feature_groups.py      |    10     | [preprocessing-feature-groups](../../tests/test_preprocessing/test-results/preprocessing-feature-groups.md)     |
| test_transformers.py        |     8     | [preprocessing-transformers](../../tests/test_preprocessing/test-results/preprocessing-transformers.md)         |
| test_pipeline_builder.py    |     6     | [preprocessing-pipeline-builder](../../tests/test_preprocessing/test-results/preprocessing-pipeline-builder.md) |
| test_label_strategy.py      |     9     | [preprocessing-label-strategy](../../tests/test_preprocessing/test-results/preprocessing-label-strategy.md)     |
| test_cv_selector.py         |     7     | [preprocessing-cv-selector](../../tests/test_preprocessing/test-results/preprocessing-cv-selector.md)           |
| test_transparency.py        |     4     | [preprocessing-transparency](../../tests/test_preprocessing/test-results/preprocessing-transparency.md)         |
| test_model_registry.py      |    10     | [preprocessing-model-registry](../../tests/test_preprocessing/test-results/preprocessing-model-registry.md)     |
| test_vae_wrapper.py         |     8     | [preprocessing-vae-wrapper](../../tests/test_preprocessing/test-results/preprocessing-vae-wrapper.md)           |
...
- **sklearn Pipeline:** Pipeline별 fit/predict + cross_val_score 동작 검증 ✅ [62 passed](../../tests/test_preprocessing/test-results/) — 8개 모듈별 리포트

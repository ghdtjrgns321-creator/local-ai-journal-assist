...
| `approval_threshold`       | 50,000,000   | B02/B03 | `st.number_input`| 1,000만 ~ 10억   |
...
| 프리셋       | 주요 변경 항목                                                                  | 대상 시나리오           |
|:------------|:------------------------------------------------------------------------------|:----------------------|
| 평시 모드    | 기본값 그대로                                                                  | 일반 감사              |
| 결산기 모드  | `midnight_start`=2, `approval_threshold` 3배, `zscore_threshold`=4.0          | 결산기(12월/3월) 감사  |
| 건설업 모드  | `period_end_margin_days`=10, `round_unit`=10,000,000                          | 건설/조선 대형 프로젝트 |

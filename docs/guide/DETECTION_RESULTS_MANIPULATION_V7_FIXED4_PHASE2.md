...
세부 기록은 `docs/spec/debugging/PHASE2_FAMILY_RESPONSIBILITY_RECALL_20260530.md`와
`docs/guide/users/16_PHASE2_RESPONSIBILITY_MAP_DECISION.md`를 따른다.
...
`docs/spec/debugging/UNSUPERVISED_NATIVE_CASE_EVIDENCE_20260530.md`이다. fixed5 measurement path에서
...
사용자용 설명 문서는 `docs/guide/users/UNSUPERVISED_DOCUMENT_COMPANION_SURFACE.md`에 둔다. 문서 언어는
...
사용자 설명 문서는 `docs/guide/users/DUPLICATE_PAIR_EVIDENCE_SURFACE.md`에 추가했다. 표현은 duplicate review

...
| LLM 응답 스키마     | `src/llm/models.py`              | [08-llm](pre-plan/08-llm.md)            | ✅   |
| 프롬프트 빌더       | `src/llm/prompt_templates.py`    | [03a-preprocessing](pre-plan/03a-preprocessing.md) | ✅   |
| LLM 전처리 제안     | `src/llm/preprocessing_advisor.py` | [03a-preprocessing](pre-plan/03a-preprocessing.md) | ✅   |

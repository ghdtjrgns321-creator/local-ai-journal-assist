...
| 2 | 설정 레이어 | `config/settings.py`, YAML 3종 | [01-project-setup](pre-plan/01-project-setup.md) | ⬜ |
| 3 | 샘플 데이터 생성기 | `data/sample/generate_sample.py` | [10-sample-data](pre-plan/10-sample-data.md) | ⬜ |
| 4 | 수동 Excel 템플릿 | `data/sample/gl_template.xlsx` | [10-sample-data](pre-plan/10-sample-data.md) | ⬜ |
...
**완료 기준**: generate_sample.py → ingest → feature → validation 파이프라인 통과

...
| 차대변 균형 불일치 | 25     | 0.008% | A01 룰 위반 카운트 (전부 라벨됨) |

### 부정 유형 Top 5 (15종 중, 2026-04-14 실측)

| 유형                   | 건수 | 대응 탐지 룰         |
|:-----------------------|:-----|:---------------------|
| SelfApproval           | 5,932 | B06 자기승인 (T5-31 역방향 라벨) |
| RevenueManipulation    | 86   | B01 수익 조작        |
| UnauthorizedAccess     | 46   | B09 승인 우회        |
| FictitiousTransaction  | 45   | B03 가공 거래        |
| DuplicatePayment       | 36   | B04 중복 지급        |

### 시간 패턴 (탐지 연계, 2026-04-14 실측)

```
시간대              비율      탐지 연계
late_night(0~6)     1.5%     C03 심야 전기
morning_spike(8~11) 29.7%    정상 업무 피크
eod_rush(16~18)     21.4%    마감 전 러시
overtime(18~22)     13.1%    야근 (주의)
midnight(22~24)      0.7%    C03 심야 (고위험)

주말 전표            2.8%    C02 주말 전기 (30,756건)
12월(연말 결산)     39,514건  C01 기말 대규모 (×1.49 평균)
```

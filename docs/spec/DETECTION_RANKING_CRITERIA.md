...
> **⚠️ SUPERSEDED (2026-07-17)**: tier(HIGH/MEDIUM/LOW/CONTEXT) 기반 ranking 은 폐지 —
> 새 SoT = [PHASE1_COMBO_BUILDER_SPEC.md](PHASE1_COMBO_BUILDER_SPEC.md). 빌더 결과 내
> 정렬(sort_key: triage → time_severity → 금액)만 본 문서의 정렬 원칙을 승계한다.

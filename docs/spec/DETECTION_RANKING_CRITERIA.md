...
|---|---|---|---|
| 가공전표 의심 | 수익·금액·모집단 통계 이상 | `(L4-01 or L4-03) + L3-02 + 2차정황1개` <br>2차정황 = `L4-04/L2-03/L3-03/L3-04/L3-10/L1-05/L1-09/L3-11` 중 하나 (A안 확장, `HIGH_COMBO_GROUNDING.md` §5b) | 금감원 189건 중 가공 전표 50건으로 최다. 240호 A45의 수기/비경상/희소계정/분포 이상 특성과 PCAOB AS 2401의 unusual journal entry 특성에 해당한다. HIGH 17건 재감사로 2차정황 풀을 실증에 맞게 확장. |

...
### 5. PHASE2 r4m_h는 accepted지만 최신 NORMAL v47와 아직 동기화되지 않았다
...
- `verification-and-tests.md`: v47 NORMAL snapshot과 r1j acceptance 기준을 반영했다.
...
| Gap | 영향 | 다음 조치 |
| --- | --- | --- |
| PHASE2 overlay가 v47 NORMAL 위에서 재생성되지 않음 | PHASE2 accepted lineage와 최신 NORMAL base가 다름 | r4m_h gate 세트를 유지하고 v47 base로 PHASE2 재생성 |

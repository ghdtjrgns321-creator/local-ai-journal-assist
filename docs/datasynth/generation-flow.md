...
v43d accepted base는 v42 계열 profile에서 다음 결함을 닫은 산출물이다.
...
현재 accepted PHASE1 recall lineage는 `datasynth_semantic_v1_recall_20260613_v42j_r3`이다.
v42j_r2는 detector recall과 shortcut scan이 통과했지만 CoA coverage gate에서 실패했고, r3에서 dataset/global CoA를 보강해 accepted 처리됐다.
...
실제 accepted run의 정확한 명령과 산출 경로는 [docs/debugging.md](../debugging.md)의 2026-06-13~2026-06-14 DataSynth 항목을 우선 확인한다.

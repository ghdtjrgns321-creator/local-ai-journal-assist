...
> **Historical/deprecated Phase 3 context (2026-05-26)**: Any Phase 3 or external LLM/API references in this raw plan are historical only and not active product capability. Active evidence policy: [LOCAL_FIRST_EVIDENCE_POLICY.md](../../LOCAL_FIRST_EVIDENCE_POLICY.md).

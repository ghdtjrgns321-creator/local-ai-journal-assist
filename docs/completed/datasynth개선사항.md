...
> 현재 운영 기준본은 `data/journal/primary/datasynth/` freeze `v59`(2026-04-27)이다. 이 문서의 초기 전수조사 수치 중 일부는 과거 기준본 분석 기록이며, 최신 운영 수치는 `data/journal/primary/datasynth/PREVIEW.md`와 `data/journal/primary/datasynth/FREEZE_V59.md`를 우선한다.

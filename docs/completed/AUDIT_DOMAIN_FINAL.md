...
| B11 | 비용 자산화    | `ExpenseCapitalization`            | 4   | 240§32, **FSS분식회계**            | 동일 doc 내 차변=자산(15xx)+대변=비용(6xxx)           | `gl_account`, `debit_amount`, `credit_amount` |
...
| C10 | 가수금 장기체류 | `SuspenseAccountAbuse`       | 3   | 외감법§8①2호, FSS횡령은폐         | `is_suspense_account == True`           | `is_suspense_account`                |

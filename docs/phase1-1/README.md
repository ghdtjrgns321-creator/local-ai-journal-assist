...
- 최신 tier 근거는 "HIGH 조합 5개"가 아니라 HIGH 10개, MEDIUM 3개, LOW scheme 1개 분류다. 이 중 HIGH-6 가공거래처, HIGH-8 재고 과대평가, HIGH-10 topside/연결조정은 HIGH 자격은 유지하되 **GL-only 범위 외**(거래처 마스터·재고 보조원장·연결 산출물 비보유)로 PHASE1-1 primary 룰을 신설하지 않는다([CONSTRAINTS.md](../spec/CONSTRAINTS.md)).

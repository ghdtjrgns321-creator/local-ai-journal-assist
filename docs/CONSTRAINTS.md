...
> **Local-first evidence boundary (2026-05-26)**: PHASE3 LLM Narrator, LLM reranking, AI review memo, Text-to-SQL, and LLM rule feedback are removed from the active product path. Active product paths do not send ledger evidence or case context to external LLM/API services. 단일 출처: [LOCAL_FIRST_EVIDENCE_POLICY.md](LOCAL_FIRST_EVIDENCE_POLICY.md), [DECISION.md §D068](DECISION.md), deprecated spec [PHASE3_REVIEW_NARRATOR_SPEC.md](PHASE3_REVIEW_NARRATOR_SPEC.md).
...
- **A3**: contract_v2 strict rule_truth 과탐 = 0 AND 미탐 = 0 ([completed/DETECTION_RESULTS_CONTRACT_V2.md](completed/DETECTION_RESULTS_CONTRACT_V2.md) A축)
...
- 전처리 전략 상세: [03a-preprocessing.md](completed/raw-plan/03a-preprocessing.md) §닭-달걀 해결
- LLM 전처리 추천: [03a-preprocessing.md](completed/raw-plan/03a-preprocessing.md) §③ LLM 전처리 제안
- LLM 룰 피드백 루프: [08-llm.md](completed/raw-plan/08-llm.md) §Audit Rules 피드백 루프 (historical/deprecated only; active product path에서 제거, [LOCAL_FIRST_EVIDENCE_POLICY.md](LOCAL_FIRST_EVIDENCE_POLICY.md))
...
> **상태 변경 (2026-04-02)**: "향후 개선"에서 **RC-5 태스크로 확정**. [completed/NEW_TASKS.MD](completed/NEW_TASKS.MD) 참조.
...
- ML 탐지기 설계: [completed/raw-plan/05a-detection-ml.md](completed/raw-plan/05a-detection-ml.md)
...
- Phase2 family 구조: [users/08_PHASE2_FAMILY_STRUCTURE.md](users/08_PHASE2_FAMILY_STRUCTURE.md)
- Fitting audit: [PHASE2_FITTING_AUDIT.md](PHASE2_FITTING_AUDIT.md)
- S8 stacking OOF audit: [completed/S8_stacking_oof_audit.md](completed/S8_stacking_oof_audit.md)
- S9 phase2 value baseline: [completed/S9_phase2_value_baseline.md](completed/S9_phase2_value_baseline.md)

...
| 3     | Review Queue Narrator (LLM이 룰 히트+ML 스코어+전표 메타 해석, 의심 후보 + 근거 + 다음 행동 제안). Text-to-SQL/Export는 비범위 — 상세 [docs/PHASE3_REVIEW_NARRATOR_SPEC.md](docs/PHASE3_REVIEW_NARRATOR_SPEC.md), 완료 리포트 [docs/completed/phase3_review_narrator_completion.md](docs/completed/phase3_review_narrator_completion.md) | 완료 (v2) |
...
| docs/DECISION.md             | 아키텍처/기술 선택 결정 로그 (D001~D043) |

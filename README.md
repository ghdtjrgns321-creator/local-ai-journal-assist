...
- 전수 조사 → 1차 스크리닝 (경계와 한계 : [1. 문제 인식과 스코프](#1-문제-인식과-스코프))
  - 전수 조사 : 표본을 뽑지 않고 원장 전 건에 룰·모집단 통계·비지도 학습을 걺
  - 1차 스크리닝 : 걸린 것을 감사인이 조합으로 좁혀 "먼저 볼 목록"을 세움
  - 목록에 올랐다는 것이 부정이라는 뜻은 아니며 확정은 감사인이 증빙으로 판단
- 세 역할 — 보는 대상이 달라 셋을 따로 세움 (상술 : [4. 핵심 설계](#4-핵심-설계))

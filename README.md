...
```
 ...
 ━━━ [3] 단위 전표 생성 메커니즘 ━━━
    ...
    ◆ 라인 수     2줄 60.7% · 4줄 16.6% · 3줄 5.8% (원본 생성기 내장 분포를 그대로 사용)
    ◆ 계정 매핑   거래 유형·차대 방향·거래 성격 3요소로 계정결정표 조회
                  ┗ 무작위 선택 금지 · 후보가 둘 이상이면 추측 없이 미해소로 남긴다
    ◆ 금액 산출   로그정규 분포 — 중앙값 약 120만원 · 하한 100원 · 상한 1,000억
                  ┗ 12%는 만원 단위 라운드 금액으로 생성 (실무의 어림 금액 재현)
    ◆ 일시 지정   기말 집중도 반영 (월말 2.5배 · 분기말 4배 · 연말 6배) · 오전 시간대 1.8배
    ◆ 적요 생성   템플릿 2,118줄에서 거래 유형에 맞는 문구를 조합
    ◆ 권한 승인   한도 초과 시 권한자 승인 배정 및 생성자 본인 배제 (단, 2% 예외 전결 허용)
    ◆ 제약 조건   시나리오별 허용 계정 화이트리스트 11종 위반 시 생성 중단 및 해당 건 폐기

...
> Stage 0~9 산출 통합 결과
> 단일 entry-point 문서: [`docs/PHASE2_FITTING_AUDIT.md`](../../../../docs/PHASE2_FITTING_AUDIT.md)
...
### 7.1 `docs/CONSTRAINTS.md` §ML 학습 전략 추가 항 (확정)
...
근거 audit: docs/PHASE2_FITTING_AUDIT.md, artifacts/S5_phase2_input_redesign.md
```

### 7.2 `docs/DECISION.md` 추가 결정 (D040 / D041 / D042 — 확정)
...
- 관련 audit: docs/PHASE2_FITTING_AUDIT.md, S4_evaluation_protocol.md, S9_phase2_value_baseline.md, S5_phase2_input_redesign.md
...
- 관련 audit: docs/PHASE2_FITTING_AUDIT.md, docs/S9_zero_day_protocol_alternatives.md §3.3
```

상세 diff 는 [`docs/PHASE2_FITTING_AUDIT.md`](../../../../docs/PHASE2_FITTING_AUDIT.md) §6 참조.

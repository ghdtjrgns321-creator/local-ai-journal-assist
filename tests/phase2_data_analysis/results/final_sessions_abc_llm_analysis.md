...
**CLAUDE.md 원칙 준수**:
- ❌ "R01/L2-02 룰 통과용 수치 타겟 설정" (fitting)
...
1. Shell vendor와 거래하는 전표는 금액이 10M~500M → **L4-03(이상 고액) 룰의 자연 타겟**
...
- **세션 B 효과**: line_text 다양성으로 L3-08(위험 적요) 룰의 false positive 감소 기대
- **세션 C 효과**: Shell company의 대액 거래가 L4-03(이상 고액) + R01(신규 대액) 자연 타겟 제공

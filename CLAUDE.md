...
- **Phase 1 (MVP)**: Excel → 정제 → 3레이어 24개 룰(A/B/C) → Benford(C07) → DuckDB → Streamlit 3탭
...
| 감사 도메인 | [docs/AUDIT_DOMAIN_FINAL.md](docs/AUDIT_DOMAIN_FINAL.md) | 24개 룰(A/B/C 3레이어), Benford 판정, 점수 체계, 도메인 용어↔코드 |

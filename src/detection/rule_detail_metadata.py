...
RULE_DETAIL_METADATA_REGISTRY: dict[str, RuleDetailMetadata] = {
    ...
    "IC01": _entry(
        ...
        presenter_surface=PresenterSurface.INTERCOMPANY_SIDECAR,
        final_topic="intercompany_cycle",
        include_in_l1_l4_transaction_count=False,
        allow_standalone_violation_copy=False,
        title="Intercompany unmatched exception",
        tone="sidecar_seed",
        column_sources=_columns(
        ...
        conflict_note="Sidecar topic seed, excluded from L1-L4 transaction count.",
    ),
    "IC02": _entry(
        "IC02",
        status=RuleStatus.SIDECAR,
        ...
        include_in_l1_l4_transaction_count=False,
        allow_standalone_violation_copy=False,
        title="Intercompany amount difference",
        tone="sidecar_seed",
        column_sources=_columns(
            ("company_code", "trading_partner"),
            ("reference", "posting_date", "debit_amount", "credit_amount"),
            derived=("counterparty",),
            sidecar=(
                "target_document_id",
                "counterpart_document_id",
    ...
    "IC03": _entry(
        ...
        include_in_l1_l4_transaction_count=False,
        allow_standalone_violation_copy=False,
        title="Intercompany timing difference",
        tone="sidecar_seed",
        column_sources=_columns(
            ("company_code", "trading_partner"),
            ("reference", "posting_date", "fiscal_period"),
            derived=("counterparty",),
            sidecar=(
                "target_document_id",
                "counterpart_document_id",
